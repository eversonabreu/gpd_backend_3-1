...
namespace GPD.Backend.Infrastructure.Database.Migrations
{
    public partial class UserDefault : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            string sql = string.Format("insert into \"Usuario\" (\"Nome\", \"Cpf\", \"Senha\", \"Email\", \"Administrador\", \"Ativo\") values ('Admin (default)', '05450395922', '{0}', 'everson.ean@gmail.com', true, true);", password);
