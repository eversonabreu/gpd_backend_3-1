...
namespace GPD.Backend.Infrastructure.Database.Migrations
{
    ...
    [Migration("20200327202321_IndicadorTabelas")]
    partial class IndicadorTabelas
    {
            ...
            modelBuilder.Entity("GPD.Backend.Domain.Entities.Indicador", b =>
                {
                    ...
                    b.Property<int>("TipoAcumuloMeta")
                        .HasColumnType("integer");

                    b.Property<int>("TipoAcumuloRealizado")
                        .HasColumnType("integer");

                    b.Property<int>("TipoCardinalidade")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GPD.Backend.Domain.Entities.IndicadorLancamento", b =>
                {
                    ...
                    b.HasIndex("IdProjeto", "IdIndicador", "DataLancamento")
                        .IsUnique()
